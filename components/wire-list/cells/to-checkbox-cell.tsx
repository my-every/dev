 ...
 * To Checkbox Cell
 * 
 * A compact checkbox for marking the "To" side of a wire as complete.
 * Supports a printVariant mode that renders a static box for print output.
 */

import { Checkbox } from "@/components/ui/checkbox";

interface ToCheckboxCellProps {
...
export function ToCheckboxCell({
  rowId,
  checked,
  onCheckedChange,
  disabled = false,
  ...
  return (
    <div className="flex items-center justify-center">
      <Checkbox
        ...
        aria-label="Mark To connection complete"
      />
    </div>
  );
}
