...
const Slider = forwardRef<HTMLDivElement, SliderProps>(
  (
    ...
    const emitChange = useCallback(
      ...
      [isRange, values, onChange, onValueChange]
    );
    ...
    const handleRadixChange = useCallback(
      ...
      [isRange, onChange, onValueChange]
    );
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Track background */}
            <motion.div
              className={cn("absolute border bg-muted/30 border-border overflow-hidden rounded-full", trackClassName)}
              initial={false}
              animate={{
...
const SliderComfortable = forwardRef<HTMLDivElement, SliderComfortableProps>(
  (
    ...
    const handlePointerDown = useCallback(
      ...
      [disabled, getValueFromX, onChange, onValueChange, fillPercent, zeroOffset, zeroTarget, min, max]
    );
    ...
    const handlePointerMove = useCallback(
      ...
      [getValueFromX, onChange, onValueChange, variant, fillPercent, zeroOffset, zeroTarget, min, max]
    );
    ...
    const handleResizePointerMove = useCallback(
      ...
      [getValueFromX, onChange, onValueChange, fillPercent, zeroOffset, zeroTarget, min, max]
    );
