...
import {
  ...
  type IconName,
  type IconComponent,
} from "@/lib/theme/icon-map";

// Re-export types for consumers
export type { IconComponent, IconName, IconLibrary } from "@/lib/theme/icon-map";
export { iconLibraryOrder, iconLibraryLabels } from "@/lib/theme/icon-map";
