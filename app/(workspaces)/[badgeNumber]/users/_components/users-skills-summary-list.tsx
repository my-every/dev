...
type UsersSkillsSummaryListProps = BaseStatefulProps<Array<{ label: string; value: string }>>;

export function UsersSkillsSummaryList({ mode = "default", data = [] }: UsersSkillsSummaryListProps) {
    return (
        <DetailSectionCard title="Skills Summary" description="Most represented skills in the active roster.">
