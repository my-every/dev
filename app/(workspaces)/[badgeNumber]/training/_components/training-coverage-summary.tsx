...
type TrainingCoverageSummaryProps = BaseStatefulProps<Array<{ label: string; value: string }>>;

export function TrainingCoverageSummary({ mode = "default", data = [] }: TrainingCoverageSummaryProps) {
    return (
        <DetailSectionCard title="Coverage Summary" description="Stages, tags, and template coverage across modules.">
